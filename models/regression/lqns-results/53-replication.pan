<?xml version="1.0"?>
<!-- lqns -pragma=variance=mol,threads=hyper -pragma=replication=pan -xml -output=53-replication.pan -->
<lqn-model name="53-replication" description="lqns 5.32 solution for 53-replication.lqnx: $FIAB = 4, $FIBC = 2, $FOAB = 2, $FOBC = 2, $KA = 4, $KB = 2, $KC = 2." xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="/usr/local/share/lqns/lqn.xsd">
  <solver-params comment="Pan Thesis, Case-4." conv_val="1e-05" it_limit="500" underrelax_coeff="0.9" print_int="10">
    ...
    <result-general solver-info="lqns 5.32" valid="true" conv-val="8.65043e-06" iterations="4" platform-info="merlin-pc.sce.carleton.ca Linux 6.17.4-200.fc42.x86_64" user-cpu-time=" 0:00:00.006" system-cpu-time=" 0:00:00.000" elapsed-time=" 0:00:00.007" max-rss="17636">

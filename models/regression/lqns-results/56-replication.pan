<?xml version="1.0"?>
<!-- lqns -pragma=variance=mol,threads=hyper,replication=prune -no-warnings -pragma=replication=pan -xml -output=56-replication-pan.lqxo -->
<lqn-model name="56-replication" description="lqns 5.28.4 solution for model from: 56-replication.lqnx." xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="/usr/local/share/lqns/lqn.xsd">
  <solver-params comment="Table 1, Set 5, Prune Replication" conv_val="1e-06" it_limit="50" underrelax_coeff="0.9" print_int="5">
    ...
    <result-general solver-info="lqns 5.28.4" valid="true" conv-val="7.17329e-07" iterations="11" platform-info="MacBook-Pro.local Darwin 22.4.0" user-cpu-time=" 0:00:00.011" system-cpu-time=" 0:00:00.000" elapsed-time=" 0:00:00.011" max-rss="6635520">
      <mva-info submodels="3" core="54" step="531" step-squared="7975" wait="92180" wait-squared="4.08411e+08" faults="0"/>
    </result-general>
  </solver-params>
  <processor name="p1" scheduling="fcfs">
    ...
    <task name="t1" scheduling="ref">
      ...
      <entry name="e1" type="NONE">
        <result-entry utilization="1" throughput="0.658354" proc-utilization="0.186534" squared-coeff-variation="0.536131" throughput-bound="1" phase1-service-time="1.51894" phase1-service-time-variance="1.23695" phase1-utilization="1"/>
      </entry>
      <task-activities>

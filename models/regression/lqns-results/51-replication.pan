<?xml version="1.0"?>
<!-- lqns -pragma=variance=mol,threads=hyper -pragma=replication=pan -xml -output=51-replication-pan.lqxo -->
<lqn-model name="51-replication" description="lqns 5.28.4 solution for model from: 51-replication.lqnx." xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="/usr/local/share/lqns/lqn.xsd">
  <solver-params comment="Replicated model from Pan thesis." conv_val="1e-05" it_limit="500" underrelax_coeff="0.9" print_int="10">
    ...
    <result-general solver-info="lqns 5.28.4" valid="true" conv-val="1.6293e-06" iterations="2" platform-info="Gregs-Retina-iMac.local Darwin 22.3.0" user-cpu-time=" 0:00:00.016" system-cpu-time=" 0:00:00.000" elapsed-time=" 0:00:00.016" max-rss="2498560">

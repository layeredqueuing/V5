% 
% $Id: call.tex 14472 2021-02-11 16:43:45Z greg $
% 
% ----------------------------------------------------------------------
\section{Call}
\label{sec:call}
...
\item[rnvCalls] \texonly{---} The number of rendezvous, by 
  ...
  \link{\code{store\_rnv\_data()}}{sec:entry-load}. 

\item[snrCalls] \texonly{---} The number of asynchronous requests, by
  phase of \var{source}.  Set by calls to
  \link{\code{store\_snr\_data()}}{sec:entry-load}. 
...
\item[partition] \texonly{---} The \link{\bf{partition}}[
...
\item[type] \texonly{---} \\
\code{phase\_type phaseTypeFlag( const unsigned phase ) }

/*  -*- c++ -*-
 * $HeadURL: svn://192.168.2.10/lqn/trunk-V5/lqns/unit-test/test9d.cc $
 *
 * Multiserver test.  Conway / de Souza e Silva and Muntz waiting time.
 *
 * ------------------------------------------------------------------------
 * $Id: test9d.cc 8841 2009-07-14 14:21:57Z greg $
 * ------------------------------------------------------------------------
 */
...
void
test( PopVector& NCust, Vector<Server *>& Q, VectorMath<double>& Z, VectorMath<unsigned>& priority, const unsigned s22_ix )
{

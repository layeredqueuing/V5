/*  -*- c++ -*-
 * $HeadURL: svn://192.168.2.10/lqn/trunk-V5/lqns/unit-test/test4.cc $
 *
 ...
 *
 * ------------------------------------------------------------------------
 * $Id: test4.cc 8841 2009-07-14 14:21:57Z greg $
 * ------------------------------------------------------------------------
 */
...
void
test( PopVector& NCust, Vector<Server *>& Q, VectorMath<double>& Z, VectorMath<unsigned>& priority, const unsigned v5_ix )
{

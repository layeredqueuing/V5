<?xml version="1.0"?>
<!-- lqns -pragma=variance=mol,threads=hyper -no-warnings -pragma=replication=pan -xml -output=52-replication.pan -->
<lqn-model name="52-replication" description="lqns 5.32 solution for 52-replication.lqnx." xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="/usr/local/share/lqns/lqn.xsd">
  <solver-params comment="Simplified model from bug 166, Prune replication" conv_val="0.01" it_limit="75" underrelax_coeff="0.9" print_int="1">
    ...
    <result-general solver-info="lqns 5.32" valid="true" conv-val="0.00391427" iterations="2" platform-info="Mac Darwin 24.6.0" user-cpu-time=" 0:00:00.000" system-cpu-time=" 0:00:00.000" elapsed-time=" 0:00:00.000" max-rss="6832128">

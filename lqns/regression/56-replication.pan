<?xml version="1.0"?>
<!-- lqns -pragma=variance=mol,threads=hyper -no-warnings -pragma=replication=pan -xml -output=56-replication.pan -->
<lqn-model name="56-replication" description="lqns 5.32 solution for 56-replication.lqnx." xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="/usr/local/share/lqns/lqn.xsd">
  <solver-params comment="Table 1, Set 5, Prune Replication" conv_val="1e-06" it_limit="50" underrelax_coeff="0.9" print_int="5">
    ...
    <result-general solver-info="lqns 5.32" valid="true" conv-val="7.05967e-07" iterations="11" platform-info="Mac Darwin 24.6.0" user-cpu-time=" 0:00:00.006" system-cpu-time=" 0:00:00.000" elapsed-time=" 0:00:00.006" max-rss="7110656">
      <mva-info submodels="3" core="57" step="577" step-squared="8791" wait="101972" wait-squared="4.66816e+08" faults="0"/>
    </result-general>
  </solver-params>
  <processor name="d1" scheduling="fcfs" replication="4">
    ...
    <task name="d1" scheduling="fcfs" replication="4">
      ...
      <entry name="d1" type="PH1PH2">
        <result-entry utilization="0.186534" throughput="4.66334" proc-utilization="0.186534" squared-coeff-variation="1" throughput-bound="25"/>
  ...
  <processor name="p1" scheduling="fcfs">
    ...
    <task name="t1" scheduling="ref">
      ...
      <entry name="e1" type="NONE">
        <result-entry utilization="1" throughput="0.658354" proc-utilization="0" squared-coeff-variation="0.536131" throughput-bound="2" phase1-service-time="1.51894" phase1-service-time-variance="1.23695" phase1-utilization="1"/>
      </entry>
      <task-activities>

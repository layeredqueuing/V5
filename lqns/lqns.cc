...
int main (int argc, char *argv[])
{
	...
	case 'M':
	    flags.deprecate_merge = false;	/* BUG 38 */
	    break;
...
void init_flags()
{
    flags.no_execute		= 0;
    flags.bounds_only		= 0;
    flags.parseable_output	= 0;
    flags.rtf_output		= 0;
    flags.xml_output		= 0;
    flags.generate		= 0;
    flags.deprecate_merge	= 1;		/* See BUG_38 */

    flags.trace_activities	= 0;
    flags.trace_convergence	= false;
    flags.trace_delta_wait	= 0;
    flags.trace_forks		= 0;
    flags.trace_idle_time 	= 0;
    flags.trace_interlock	= 0;
    flags.trace_joins		= 0;
    flags.trace_mva		= 0;
    flags.trace_overtaking	= 0;
    flags.trace_intermediate	= false;
    flags.trace_wait		= 0;
    flags.trace_replication	= 0;

    flags.print_overtaking	= 0;
    flags.single_step		= 0;
    ...
    flags.override_iterations	     = 0;
    flags.override_convergence	     = 0;
    flags.override_print_interval    = 0;
    flags.override_underrelaxation   = 0;
    flags.ignore_overhanging_threads = 0;
    flags.full_reinitialize	     = 0;		/* Maybe a pragma?			*/
    flags.reload_only		     = 0;

    flags.trace_task      = 0;
    flags.trace_processor = 0;
    flags.trace_entry     = 0;
}
...
get_pragma( const char * p )
{
    ...
    bool rc = true;
    LQIO::input_file_name = "COMMAND LINE";	/* Set up for error message if necessary. */

...
/*
 * $Id: petrisrvn.cc 15813 2022-08-11 19:18:33Z greg $
 *
    ...
    /* name */ /* has arg */ /*flag */ /* val */
{
    ...
    { "marginal-probabilities", no_argument,	0, 'M' },
...
static const char * opthelp[]  = {
    ...
    /* "marginal-probabilities" */"Save the marginal queue probabilites in the results.",
